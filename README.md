...
## Live Demo
[Press here for live demo!](https://shz1993-natural-language-sql-agent-project-build-app-r01ojk.streamlit.app/)
...
3. Create `.streamlit/secrets.toml` with your DB and Groq keys
